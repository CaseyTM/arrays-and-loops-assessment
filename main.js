...
// A:
var doublyAwesomeArrayOfDoom = [
["steve", "mike"],
["bob", "mark"]
]
function joinArrays(twoDimensionalArray){
	let newArray = [];
	for(let i = twoDimensionalArray.length; i >= 0; i--){
...
joinArrays(doublyAwesomeArrayOfDoom)
